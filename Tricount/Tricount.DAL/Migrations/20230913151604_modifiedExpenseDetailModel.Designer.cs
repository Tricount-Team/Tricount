...
namespace Tricount.DAL.Migrations
{
    ...
    [Migration("20230913151604_modifiedExpenseDetailModel")]
    partial class modifiedExpenseDetailModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.Expense", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("227dbfd6-4315-4189-a3a1-790aea41d332");
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.ExpenseDetail", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("d1aa4644-a610-45ca-86c2-261986c47ca6");
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.Group", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("48af55fb-3be6-4c9d-8b19-80fd0eb13664");
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.Invite", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("a385851e-f3dc-4aaa-8179-2dae59d3d73a");
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.Payment", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("67a2264b-c353-4ec9-b0e9-14f7965dc184");
