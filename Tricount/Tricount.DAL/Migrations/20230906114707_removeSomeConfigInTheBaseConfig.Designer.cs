...
namespace Tricount.DAL.Migrations
{
    ...
    [Migration("20230906114707_removeSomeConfigInTheBaseConfig")]
    partial class removeSomeConfigInTheBaseConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.Expense", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("ed95136c-1cbb-4c61-bd68-b633fe53df74");
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.ExpenseDetail", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("ebfaf653-63e7-49bc-8aba-cb00fa5340ea");
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.Group", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("a02b5132-67e5-4a09-a289-7731e7c6ef02");
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.Invite", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("bf32b7d0-465e-4c6d-aa3f-299fab069f48");
            ...
            modelBuilder.Entity("Tricount.Entities.Concrete.Payment", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                        .HasDefaultValue("00044a7e-8478-4855-9dd0-ad5d30696555");
